...
### macOS
1. Download **`TapeNexus-1.0.21.pkg`** from the [latest release](https://github.com/jinthoa/TapeNexus/releases/latest).
...
3. Launch from `/Applications`.
   ...
   Prefer the terminal? `sudo installer -pkg ~/Downloads/TapeNexus-1.0.21.pkg -target /`
